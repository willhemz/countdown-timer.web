...
const Home = () => {
  return <div className='mt-8 sm:-mt-10 sm:h-[30rem] flex flex-col sm:flex-row justify-center items-center relative font-Quicksand text-#222222'>
    ...
    <div className='hidden sm:block'>
        <img className='w-[338px] h-[485px] absolute -top-10 right-0' src="./Assets/images/bg1.png" alt="" />
